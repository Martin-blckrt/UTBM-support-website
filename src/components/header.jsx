    ...
    if (isBrowser()) {
        return (
            <div css={headingBackground(props.headerOpacity, props.boxShadowOpacity)}>
                ...
                <div css={second_div_style}>
                    {window.location.pathname !== "/" &&
                    <div css={div_arbo_style}>
                        <svg css={arbo_style} width="11" height="12" viewBox="0 0 11 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M1.25 18.25L9.75 10L1.25 1.75" stroke="#303030" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                        <p css={arbo_style}>{props.arbo}</p>
                        {props.arboArticle !== undefined &&
                        <svg css={arbo_style} width="11" height="12" viewBox="0 0 11 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M1.25 18.25L9.75 10L1.25 1.75" stroke="#303030" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>}
                        <p css={arbo_style}>{props.arboArticle}</p>
                    </div>
                    }
                </div>
            </div>
